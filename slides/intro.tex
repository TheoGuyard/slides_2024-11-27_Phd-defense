    ...
    \begin{tikzpicture}[remember picture,overlay]
        \begin{scope}[xshift=0.5\textwidth]
            ...
            \onslide<4-> {
                ...
                \node [text width=0.35\linewidth, align=center,font=\small,anchor=north] at ($(penalty)+(0,-0.35)$) {Linked to the \\ \textcolor{TolLightOrange}{application} / Used to enable \textcolor{TolLightOrange}{solution methods}};
            }
            %
            %
            %
