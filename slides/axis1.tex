...
\begin{frame}{Axis 1 -- Generic relaxation construction}
  \begin{tikzpicture}[remember picture,overlay]
    \begin{scope}[xshift=0.5\linewidth]
      ...
      %
      \onslide<5-> {
        \node[text width=0.75\linewidth,align=left] at (0.75,-3.6) {$\rightarrow$ $\lfunc$ and $\pfunc$ proper, closed, convex \\ $\rightarrow$ $\pfunc$ separable, even, supercoercive, $\pfunc \geq \pfunc(\0) = 0$};
      }
    \end{scope}
  \end{tikzpicture}
\end{frame}
